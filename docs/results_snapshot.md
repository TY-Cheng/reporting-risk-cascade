...
_Generated by `just snapshot` from `artifacts/full_with_peer` at `2026-07-11T21:19:11+00:00`._
...
- **Highest equal-task public-cascade row.** `all + expanding` with reported mean PR-AUC `0.2830`. Use this as a descriptive configuration diagnostic, not as a model-selection headline.
...
| Field | Value |
| --- | --- |
| Artifact generation time | `2026-07-11T20:46:24+00:00` |
| Snapshot generation time | `2026-07-11T21:19:11+00:00` |
| Snapshot mode | `full` |
| Study commit | `06e95cf15423435dc252474ab90f08233cb4dbf7` |
| Git dirty | `False` |
| Config hash | `b7d16277bcdbc63ed0073518832797249b6fe9ca07ccdbea27d197458859f7ce` |
| Input hash | `2e9a375d66b63499fcf1c6d84616a9bd7f916a505215649858f462187d7b78c3` |
...
| Public-lake commit | `06e95cf15423435dc252474ab90f08233cb4dbf7` |
| Public-lake Git dirty | `False` |
| Public-lake config hash | `a152148453ac37ae8eb44e577c817ffd587552cdafb24b2aa37b791cefe6e375` |
| Public-lake input hash | `41cc868763baa3e5e93eb6bb0220aecf24d00d6297d56006a12129da0fb69680` |
...
| WRDS extraction time | `2026-07-11T20:36:59+00:00` |
| WRDS hash | `fb67a3089f78b4aecc471b66bab9a9675e79a0bb9acaaf1a8baa8f041624c968` |
...
| Public issuer dimension input | `True` | `7cf286305d0deb98d360e76234f03f623c1fe3151c263dd5cf88f27d447384cb` |
| Public issuer-origin panel input | `True` | `ab27053f6fc1732c1301c246dc688191e1031a33dc5d7e492aeccb4799f57f29` |
| Public-lake final report input | `True` | `74dc470b239f787513598d41d03ba56f5869aca867ad9f2b86a1660371181c65` |
| CIK-GVKEY bridge input | `True` | `fb67a3089f78b4aecc471b66bab9a9675e79a0bb9acaaf1a8baa8f041624c968` |
| Public-lake run metadata input | `True` | `e0c259c7e5f20fdb96badbbf56e86649a50ec314445e4a1d2fde0f2df03d0d2f` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `comment_thread` | 96,733 | 0.2689 | 0.4580 | 0.0528 | 0.0955 | 0.5806 | `fit` |
| `amendment` | 96,733 | 0.1853 | 0.4580 | -0.0490 | 0.0815 | 0.5481 | `fit` |
| `8k_402` | 96,733 | 0.0215 | 0.4580 | -0.0243 | 0.0308 | 0.4307 | `fit` |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `comment_thread` | 15,682 | 0.2531 | 0.4490 | 0.7180 | -0.0980 | 0.1857 | 9 | 9 |
| `amendment` | 9,245 | 0.1500 | 0.3346 | 0.7243 | -0.3135 | 0.2043 | 9 | 9 |
| `8k_402` | 1,298 | 0.0208 | 0.0655 | 0.7648 | -6.4185 | 0.2337 | 9 | 9 |
...
| --- | --- | --- | --- | --- | --- | --- |
| `all` | 76 | 11 | 15 | 0.2817 | 0.7329 | 108 |
| `metadata` | 25 | 0 | 0 | 0.2674 | 0.7127 | 108 |
| `visibility_history` | 23 | 0 | 0 | 0.2655 | 0.7091 | 108 |
| `xbrl` | 42 | 11 | 15 | 0.2215 | 0.6568 | 108 |
| `oversight` | 1 | 0 | 0 | 0.1564 | 0.5343 | 108 |
| `auditor` | 6 | 0 | 0 | 0.1483 | 0.5183 | 108 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `8k_402` | `all` | 0.0208 | 0.0622 | 0.7576 | -6.0903 | 0.2228 | 9 | 36 |
| `8k_402` | `visibility_history` | 0.0208 | 0.0559 | 0.7155 | -8.0572 | 0.2789 | 9 | 36 |
| `8k_402` | `metadata` | 0.0208 | 0.0490 | 0.7231 | -8.0558 | 0.2819 | 9 | 36 |
| `8k_402` | `xbrl` | 0.0208 | 0.0404 | 0.6624 | -8.6765 | 0.2938 | 9 | 36 |
| `8k_402` | `auditor` | 0.0208 | 0.0284 | 0.5300 | -15.5661 | 0.4581 | 9 | 36 |
| `8k_402` | `oversight` | 0.0208 | 0.0235 | 0.5221 | -14.2896 | 0.4234 | 9 | 36 |
| `amendment` | `visibility_history` | 0.1500 | 0.3366 | 0.7168 | -0.4824 | 0.2514 | 9 | 36 |
| `amendment` | `metadata` | 0.1500 | 0.3360 | 0.7161 | -0.3882 | 0.2275 | 9 | 36 |
| `amendment` | `all` | 0.1500 | 0.3332 | 0.7229 | -0.3929 | 0.2211 | 9 | 36 |
| `amendment` | `xbrl` | 0.1500 | 0.2234 | 0.6358 | -0.7522 | 0.2929 | 9 | 36 |
| `amendment` | `oversight` | 0.1500 | 0.1686 | 0.5308 | -1.0031 | 0.3454 | 9 | 36 |
| `amendment` | `auditor` | 0.1500 | 0.1586 | 0.5183 | -1.0456 | 0.3566 | 9 | 36 |
| `comment_thread` | `all` | 0.2531 | 0.4497 | 0.7182 | -0.1090 | 0.1894 | 9 | 36 |
| `comment_thread` | `metadata` | 0.2531 | 0.4171 | 0.6988 | -0.1503 | 0.1966 | 9 | 36 |
| `comment_thread` | `visibility_history` | 0.2531 | 0.4039 | 0.6949 | -0.1574 | 0.2028 | 9 | 36 |
| `comment_thread` | `xbrl` | 0.2531 | 0.4008 | 0.6723 | -0.2555 | 0.2405 | 9 | 36 |
| `comment_thread` | `oversight` | 0.2531 | 0.2770 | 0.5499 | -0.3470 | 0.2498 | 9 | 36 |
| `comment_thread` | `auditor` | 0.2531 | 0.2580 | 0.5065 | -0.3392 | 0.2458 | 9 | 36 |
...
| --- | --- | --- | --- | --- | --- |
| Filing size | Below median (1,855,951) | 99,610 | 0.1117 | 0.2538 | 0.0169 |
| Filing size | At/above median (1,855,951) | 99,610 | 0.2951 | 0.1914 | 0.0251 |
| XBRL log assets | Below median (19.0641) | 39,875 | 0.2879 | 0.2337 | 0.0287 |
| XBRL log assets | At/above median (19.0641) | 39,875 | 0.3017 | 0.1252 | 0.0163 |
...
| Days since prior filing | Below median (13.0000) | 97,769 | 0.2702 | 0.2163 | 0.0247 |
| Days since prior filing | At/above median (13.0000) | 100,560 | 0.1400 | 0.2284 | 0.0176 |
...
| Model | Metric rows | Mean PR-AUC | Mean ROC-AUC | Max config PR-AUC | Mean Brier |
| --- | --- | --- | --- | --- | --- |
| `bertomeu_style_xgb` | 540 | 0.2158 | 0.6367 | 0.5108 | 0.1091 |
| `bao_inspired_tree_ensemble` | 540 | 0.2158 | 0.6364 | 0.5128 | 0.1090 |
| `perols_bagged` | 540 | 0.2056 | 0.6237 | 0.4726 | 0.2254 |
| `perols_stacking` | 540 | 0.1992 | 0.6111 | 0.4595 | 0.2261 |
| `perols_mlp` | 540 | 0.1949 | 0.6082 | 0.4484 | 0.2288 |
| `perols_linear_svm` | 540 | 0.1934 | 0.6082 | 0.5646 | 0.2267 |
| `perols_entropy_tree` | 540 | 0.1929 | 0.6068 | 0.4358 | 0.2302 |
| `perols_logit` | 540 | 0.1917 | 0.6063 | 0.4343 | 0.2244 |
| `dechow_public_xbrl_proxy_logit` | 108 | 0.1525 | 0.4800 | 0.3020 | 0.2500 |

### Public Peer Task Summary

| Task | Metric rows | Mean prevalence | Mean PR-AUC | Mean ROC-AUC | Max config PR-AUC |
| --- | --- | --- | --- | --- | --- |
| `comment_thread` | 1,476 | 0.2531 | 0.3329 | 0.6075 | 0.5128 |
| `amendment` | 1,476 | 0.1500 | 0.2277 | 0.6097 | 0.3919 |
| `8k_402` | 1,476 | 0.0208 | 0.0393 | 0.6243 | 0.5646 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Public score to benchmark positives | `public_cascade` | `Item 4.02` | 0.0357 | 0.6970 | 0.0358 | 0.9642 | 3.0378 | [2.3082, 3.8771] |
| Detected-misstatement score to public labels | `benchmark_xgb` | `Item 4.02` | 0.0354 | 0.6747 | 0.0420 | 0.9580 | 2.6429 | [2.2561, 3.0510] |
...
| --- | --- | --- | --- | --- | --- |
| `public_to_benchmark` | 72 | `{"bridge_tier": "high_confidence", "feature_set": "all", "label_mode": "benchmark_naive", "model_id": "public_cascade", "score_aggregation": "mean", "task": "8k_402", "train_window": "rolling_7y"}` | 3.4083 | 3.0378 | 0.3705 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| comment_thread | 15,682 | 9 | 9 | 0.2531 | 0.4490 | 0.4517 | 0.0026 | [0.4181, 0.4800] | 0.7180 | 0.2050 | -0.0980 | 0.1857 |
| amendment | 9,245 | 9 | 9 | 0.1500 | 0.3346 | 0.3359 | 0.0013 | [0.2971, 0.3721] | 0.7243 | 0.1644 | -0.3135 | 0.2043 |
| 8k_402 | 1,298 | 9 | 9 | 0.0208 | 0.0655 | 0.0575 | -0.0080 | [0.0431, 0.0879] | 0.7648 | 0.1129 | -6.4185 | 0.2337 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| all | 76 | 11 | 15 | expanding | 9 | 9 | 0.2817 | [0.2649, 0.2986] | 0.7329 |
| metadata | 25 | 0 | 0 | rolling_10y | 9 | 9 | 0.2674 | [0.2523, 0.2824] | 0.7127 |
| visibility_history | 23 | 0 | 0 | rolling_10y | 9 | 9 | 0.2655 | [0.2490, 0.2820] | 0.7091 |
| xbrl | 42 | 11 | 15 | rolling_5y | 9 | 9 | 0.2215 | [0.2061, 0.2370] | 0.6568 |
| oversight | 1 | 0 | 0 | expanding | 9 | 9 | 0.1564 | [0.1409, 0.1719] | 0.5343 |
| auditor | 6 | 0 | 0 | rolling_5y | 9 | 9 | 0.1483 | [0.1356, 0.1611] | 0.5183 |
...
| Model | n_folds | valid_folds | Mean_PR_AUC | PR_AUC_Dispersion | Mean_ROC_AUC |
| --- | --- | --- | --- | --- | --- |
| bertomeu_style_xgb | 9 | 9 | 0.2158 | [0.2020, 0.2296] | 0.6367 |
| bao_inspired_tree_ensemble | 9 | 9 | 0.2158 | [0.2020, 0.2295] | 0.6364 |
| perols_bagged | 9 | 9 | 0.2056 | [0.1927, 0.2185] | 0.6237 |
| perols_stacking | 9 | 9 | 0.1992 | [0.1867, 0.2117] | 0.6111 |
| perols_mlp | 9 | 9 | 0.1949 | [0.1808, 0.2089] | 0.6082 |
| perols_linear_svm | 9 | 9 | 0.1934 | [0.1762, 0.2107] | 0.6082 |
| perols_entropy_tree | 9 | 9 | 0.1929 | [0.1810, 0.2048] | 0.6068 |
| perols_logit | 9 | 9 | 0.1917 | [0.1767, 0.2066] | 0.6063 |
| dechow_public_xbrl_proxy_logit | 9 | 9 | 0.1525 | [0.1378, 0.1672] | 0.4800 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Public score to benchmark positives | public_cascade | Item 4.02 | all | expanding | 11,443 | 135 | 1,144 | 41 | 0.0357 | 3.0378 | 0.0358 | 0.9642 | [2.3082, 3.8771] | high_confidence |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| comment_thread | fit | 96,733 | 0.2689 | 59 | 62 | 17 | 0.0528 | 0.0955 | [-0.1344, 0.2400] | 0.5806 |
| amendment | fit | 96,733 | 0.1853 | 59 | 62 | 17 | -0.0490 | 0.0815 | [-0.2088, 0.1108] | 0.5481 |
| 8k_402 | fit | 96,733 | 0.0215 | 59 | 62 | 17 | -0.0243 | 0.0308 | [-0.0846, 0.0361] | 0.4307 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 8k_402 | all | 9 | 9 | 0.0208 | 0.0622 | [0.0429, 0.0816] | 0.7576 | -6.0903 | 0.2228 |
| 8k_402 | visibility_history | 9 | 9 | 0.0208 | 0.0559 | [0.0304, 0.0814] | 0.7155 | -8.0572 | 0.2789 |
| 8k_402 | metadata | 9 | 9 | 0.0208 | 0.0490 | [0.0329, 0.0652] | 0.7231 | -8.0558 | 0.2819 |
| 8k_402 | xbrl | 9 | 9 | 0.0208 | 0.0404 | [0.0249, 0.0560] | 0.6624 | -8.6765 | 0.2938 |
| 8k_402 | auditor | 9 | 9 | 0.0208 | 0.0284 | [0.0137, 0.0430] | 0.5300 | -15.5661 | 0.4581 |
| 8k_402 | oversight | 9 | 9 | 0.0208 | 0.0235 | [0.0093, 0.0378] | 0.5221 | -14.2896 | 0.4234 |
| amendment | visibility_history | 9 | 9 | 0.1500 | 0.3366 | [0.3115, 0.3617] | 0.7168 | -0.4824 | 0.2514 |
| amendment | metadata | 9 | 9 | 0.1500 | 0.3360 | [0.3116, 0.3603] | 0.7161 | -0.3882 | 0.2275 |
| amendment | all | 9 | 9 | 0.1500 | 0.3332 | [0.2951, 0.3713] | 0.7229 | -0.3929 | 0.2211 |
| amendment | xbrl | 9 | 9 | 0.1500 | 0.2234 | [0.1984, 0.2483] | 0.6358 | -0.7522 | 0.2929 |
| amendment | oversight | 9 | 9 | 0.1500 | 0.1686 | [0.1414, 0.1959] | 0.5308 | -1.0031 | 0.3454 |
| amendment | auditor | 9 | 9 | 0.1500 | 0.1586 | [0.1454, 0.1718] | 0.5183 | -1.0456 | 0.3566 |
| comment_thread | all | 9 | 9 | 0.2531 | 0.4497 | [0.4183, 0.4811] | 0.7182 | -0.1090 | 0.1894 |
| comment_thread | metadata | 9 | 9 | 0.2531 | 0.4171 | [0.3902, 0.4440] | 0.6988 | -0.1503 | 0.1966 |
| comment_thread | visibility_history | 9 | 9 | 0.2531 | 0.4039 | [0.3768, 0.4310] | 0.6949 | -0.1574 | 0.2028 |
| comment_thread | xbrl | 9 | 9 | 0.2531 | 0.4008 | [0.3629, 0.4388] | 0.6723 | -0.2555 | 0.2405 |
| comment_thread | oversight | 9 | 9 | 0.2531 | 0.2770 | [0.2507, 0.3034] | 0.5499 | -0.3470 | 0.2498 |
| comment_thread | auditor | 9 | 9 | 0.2531 | 0.2580 | [0.2327, 0.2834] | 0.5065 | -0.3392 | 0.2458 |
