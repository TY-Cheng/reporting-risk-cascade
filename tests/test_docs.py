...
def test_results_snapshot_exposes_current_main_artifact_results() -> None:
    ...
    required_phrases = [
        ...
        "2026-04-26T11:49:59+00:00",
        "Evidence Map",
        "Peer-compatible benchmark suite",
        ...
        "gvkey-CIK-year",
        "high-coverage candidate bridge",
        "Discussion",
        "peer-compatible model-family comparison is now complete",
