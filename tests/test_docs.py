...
def test_development_audit_prompt_targets_code_against_paper_plan() -> None:
    ...
    required_phrases = [
        ...
        "raw_identifier_blocker",
        "--peer-target legacy/public/both",
        "public_model_family_metrics.csv",
        ...
        "public_model_family_manifest.json",
        "public_model_family_blockers.json",
